...
/*
 * FILE ROLE:
 *   Ensures AdoNetTutorial schema and seed data exist before EF Core loading demos run.
 *
 * SECTIONS IN THIS FILE:
 *   3. Database bootstrap - DDL and seed SQL (documented below)
 */

/*
 * SECTION 3: DATABASE BOOTSTRAP - DDL AND SEED SQL
 *
 * Same Customers / Orders / OrderLines / Products shape as ADO.NET and Dapper chapters.
 * EF Core maps entities in Data/ShopDbContext.cs; this class only guarantees rows exist.
 *
...
public static class DatabaseBootstrap
{
    ...
    private static bool TableExists(SqlConnection connection)
    {
        ...
        command.CommandText =
            """
            SELECT CASE WHEN OBJECT_ID(N'dbo.Orders', N'U') IS NOT NULL THEN 1 ELSE 0 END;
            """;
