...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=INBLRVM26590142;Database=BikeStores;Trusted_Connection=True;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E270D0D527A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B40B280E15");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85509CD835");

            entity.ToTable("customers", "sales");

            entity.HasIndex(e => new { e.FirstName, e.LastName }, "nameIndex");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229AC72C88C");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D44B95AB8F");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF54F726987");

            entity.ToTable("products", "production");

            entity.HasIndex(e => e.ProductName, "pnameIndex");
        ...
        modelBuilder.Entity<ProductView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("product_view", "production");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CE3F0F2CA");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164D32CE478").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D37E65236D");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C0540B62B");
        ...
        modelBuilder.Entity<Team>(entity =>
        {
            ...
            entity.HasIndex(e => e.TeamName, "teamNameIndex").IsClustered();

            entity.HasIndex(e => e.TeamId, "uniqId").IsUnique();
