...
- [01. Introduction to LINQ](#01-introduction-to-linq)
  - [Q1. What is LINQ, and what problem does it unify across in-memor…](#01-introduction-to-linq-q1)
  - [Q2. What is the difference between query syntax and method synta…](#01-introduction-to-linq-q2)
  - [Q3. What is deferred execution in LINQ, and which operators brea…](#01-introduction-to-linq-q3)
  - [Q4. What is the difference between deferred execution and lazy e…](#01-introduction-to-linq-q4)
  - [Q5. What is the difference between `IEnumerable<T>` and `IQuerya…](#01-introduction-to-linq-q5)
  - [Q6. What is an expression tree, and why does `IQueryable` depend…](#01-introduction-to-linq-q6)
  - [Q7. What is the difference between LINQ to Objects and LINQ to E…](#01-introduction-to-linq-q7)
  - [Q8. What is the role of the `Enumerable` vs `Queryable` static c…](#01-introduction-to-linq-q8)
  - [Q9. What does it mean for a LINQ provider to translate a query? …](#01-introduction-to-linq-q9)
  - [Q10. How do you inspect or debug the SQL generated by an `IQuerya…](#01-introduction-to-linq-q10)
  - [Q11. What is the difference between chaining LINQ operators vs bu…](#01-introduction-to-linq-q11)
  - [Q12. What are common signs that LINQ is hurting readability, and …](#01-introduction-to-linq-q12)
  - [Q13. How does LINQ interact with nullable reference types and nul…](#01-introduction-to-linq-q13)
  - [Q14. What is query rewriting (e.g., `let`, `join`, `group` in que…](#01-introduction-to-linq-q14)

- [02. Filtering & Aggregation](#02-filtering-aggregation)
  - [Q1. What is the difference between `.Where()` and `.Select()` in…](#02-filtering-aggregation-q1)
  - [Q2. When should you filter before projecting vs project before f…](#02-filtering-aggregation-q2)
  - [Q3. What is the difference between `.Count()`, `.LongCount()`, `…](#02-filtering-aggregation-q3)
  - [Q4. What happens when `.Average()` or `.Sum()` is called on an e…](#02-filtering-aggregation-q4)
  - [Q5. What is `.Aggregate()`, and how does it generalize other agg…](#02-filtering-aggregation-q5)
  - [Q6. How do seed and accumulator overloads of `.Aggregate()` work…](#02-filtering-aggregation-q6)
  - [Q7. What is the difference between `.Aggregate()` with and witho…](#02-filtering-aggregation-q7)
  - [Q8. What is `.Count(predicate)` vs `.Where().Count()` in terms o…](#02-filtering-aggregation-q8)
  - [Q9. What is the difference between `.Any()` and `.Count() > 0` f…](#02-filtering-aggregation-q9)
  - [Q10. How do nullable numeric aggregations behave in LINQ to Objec…](#02-filtering-aggregation-q10)
  - [Q11. What is the difference between `.Sum()` on `int` vs `long` v…](#02-filtering-aggregation-q11)
  - [Q12. How do aggregations translate (or fail to translate) in LINQ…](#02-filtering-aggregation-q12)
  - [Q13. When would you use `.Aggregate()` instead of a simple loop f…](#02-filtering-aggregation-q13)
  - [Q14. What are pitfalls of aggregating floating-point values from …](#02-filtering-aggregation-q14)

- [03. Ordering](#03-ordering)
  - [Q1. What is the difference between `OrderBy().ThenBy()` and call…](#03-ordering-q1)
  - [Q2. What is stable sort in LINQ to Objects, and why does it matt…](#03-ordering-q2)
  - [Q3. Does `OrderBy` guarantee stability across all .NET versions …](#03-ordering-q3)
  - [Q4. What is the difference between `OrderBy` and `OrderByDescend…](#03-ordering-q4)
  - [Q5. How do `ThenBy` and `ThenByDescending` chain comparers?](#03-ordering-q5)
  - [Q6. Can you sort by multiple keys using query syntax? How?](#03-ordering-q6)
  - [Q7. What is the difference between sorting before `GroupBy` vs s…](#03-ordering-q7)
  - [Q8. How does `IOrderedEnumerable<T>` differ from `IEnumerable<T>…](#03-ordering-q8)
  - [Q9. When should you pass a custom `IComparer<T>` to `OrderBy`?](#03-ordering-q9)
  - [Q10. How does ordering translate to SQL in EF Core (`ORDER BY`, c…](#03-ordering-q10)
  - [Q11. What is the performance characteristic of `OrderBy` in LINQ …](#03-ordering-q11)
  - [Q12. What happens if the key selector throws for some elements du…](#03-ordering-q12)
  - [Q13. How do `OrderBy` and `Reverse()` interact — does `Reverse` u…](#03-ordering-q13)
  - [Q14. When is in-memory sorting the wrong choice for large EF Core…](#03-ordering-q14)

- [04. Grouping](#04-grouping)
  - [Q1. Explain `GroupBy` in LINQ to Objects — what is the shape of …](#04-grouping-q1)
  - [Q2. What is the difference between `GroupBy(keySelector)` and `G…](#04-grouping-q2)
  - [Q3. What is the difference between `GroupBy` with a result selec…](#04-grouping-q3)
  - [Q4. How does `GroupBy` differ when translated to SQL (LINQ to En…](#04-grouping-q4)
  - [Q5. What is the difference between `GroupBy` and `ToLookup()`?](#04-grouping-q5)
  - [Q6. When should you use `ToLookup()` instead of `GroupBy().ToDic…](#04-grouping-q6)
  - [Q7. What is `ILookup<TKey, TElement>` and how is it immutable co…](#04-grouping-q7)
  - [Q8. How do you group by composite keys (anonymous types, value t…](#04-grouping-q8)
  - [Q9. How does key equality affect grouping (`Equals`/`GetHashCode…](#04-grouping-q9)
  - [Q10. What is the difference between `group by` in query syntax an…](#04-grouping-q10)
  - [Q11. How do you flatten or regroup nested groups efficiently?](#04-grouping-q11)
  - [Q12. What are common mistakes grouping large EF Core queries (cli…](#04-grouping-q12)
  - [Q13. How does `GroupBy` interact with ordering of elements within…](#04-grouping-q13)
  - [Q14. When would you prefer `Dictionary` manual grouping over `Gro…](#04-grouping-q14)

- [05. Joins](#05-joins)
  - [Q1. What is the difference between inner join, left join, and cr…](#05-joins-q1)
  - [Q2. How do you express a left outer join in method syntax vs que…](#05-joins-q2)
  - [Q3. What is the difference between `join` and `GroupJoin`?](#05-joins-q3)
  - [Q4. When should you use `GroupJoin` followed by `SelectMany` vs …](#05-joins-q4)
  - [Q5. How do you join on composite keys using anonymous types or t…](#05-joins-q5)
  - [Q6. What are equality requirements for join keys?](#05-joins-q6)
  - [Q7. What is the difference between equijoin and non-equijoin — c…](#05-joins-q7)
  - [Q8. How do joins translate to SQL in EF Core (`INNER JOIN`, `LEF…](#05-joins-q8)
  - [Q9. What is a many-to-many join pattern in LINQ?](#05-joins-q9)
  - [Q10. What performance pitfalls appear when joining large in-memor…](#05-joins-q10)
  - [Q11. How does `DefaultIfEmpty()` enable left outer join semantics…](#05-joins-q11)
  - [Q12. What is the difference between a join and a correlated subqu…](#05-joins-q12)
  - [Q13. When is `Join` preferable to building a `Dictionary` lookup …](#05-joins-q13)
  - [Q14. What happens when duplicate keys exist on the inner or outer…](#05-joins-q14)

- [06. Element Operations](#06-element-operations)
  - [Q1. What is the difference between `.First()`, `.FirstOrDefault(…](#06-element-operations-q1)
  - [Q2. What is the difference between `.Last()` and `.LastOrDefault…](#06-element-operations-q2)
  - [Q3. What is the difference between `.ElementAt(index)` and index…](#06-element-operations-q3)
  - [Q4. What is `.ElementAtOrDefault()` behavior for out-of-range in…](#06-element-operations-q4)
  - [Q5. How do element operations behave on empty sequences for each…](#06-element-operations-q5)
  - [Q6. What is the difference between `.First(predicate)` vs `.Wher…](#06-element-operations-q6)
  - [Q7. Why can `.Single()` be dangerous on filtered EF Core queries…](#06-element-operations-q7)
  - [Q8. What is the time complexity of `.ElementAt()` on a linked li…](#06-element-operations-q8)
  - [Q9. When should you use `.FirstOrDefault()` vs `.SingleOrDefault…](#06-element-operations-q9)
  - [Q10. How do element operators short-circuit enumeration?](#06-element-operations-q10)
  - [Q11. What exceptions are thrown vs null/default returned for refe…](#06-element-operations-q11)
  - [Q12. How do `.MinBy()` / `.MaxBy()` (modern LINQ) relate to eleme…](#06-element-operations-q12)

- [07. Set Operations](#07-set-operations)
  - [Q1. What is the difference between `.Distinct()`, `.Union()`, `.…](#07-set-operations-q1)
  - [Q2. How does equality comparer selection work for set operations…](#07-set-operations-q2)
  - [Q3. What is `.DistinctBy()` (modern LINQ), and how does it diffe…](#07-set-operations-q3)
  - [Q4. Are `Union`/`Intersect`/`Except` multisets or sets — how are…](#07-set-operations-q4)
  - [Q5. What is the difference between `.Union()` and `.Concat().Dis…](#07-set-operations-q5)
  - [Q6. How do set operations translate in EF Core?](#07-set-operations-q6)
  - [Q7. What is the performance of set operations on sorted vs unsor…](#07-set-operations-q7)
  - [Q8. When would you use `HashSet<T>` manually instead of LINQ set…](#07-set-operations-q8)
  - [Q9. How do reference equality and value equality change set oper…](#07-set-operations-q9)
  - [Q10. What is the difference between set operations on in-memory s…](#07-set-operations-q10)

- [08. Projection Operations](#08-projection-operations)
  - [Q1. What is the difference between `.Select()` and `.SelectMany(…](#08-projection-operations-q1)
  - [Q2. When should you use `.SelectMany()` for one-to-many relation…](#08-projection-operations-q2)
  - [Q3. What is projection to anonymous types vs named DTOs — trade-…](#08-projection-operations-q3)
  - [Q4. How do you project into nested shapes or hierarchical DTOs?](#08-projection-operations-q4)
  - [Q5. What is the difference between `.Select()` before vs after `…](#08-projection-operations-q5)
  - [Q6. How does `.Select()` interact with nullable reference types?](#08-projection-operations-q6)
  - [Q7. What is a selector that returns `IEnumerable<T>` vs flattene…](#08-projection-operations-q7)
  - [Q8. How do you project with index using `.Select((item, index) =…](#08-projection-operations-q8)
  - [Q9. What are common causes of N+1 queries related to projection …](#08-projection-operations-q9)
  - [Q10. How does `let` in query syntax relate to projection and inte…](#08-projection-operations-q10)
  - [Q11. When does projection cause full entity materialization vs co…](#08-projection-operations-q11)
  - [Q12. What is the difference between projecting computed values vs…](#08-projection-operations-q12)
  - [Q13. What is `.Zip()`, and how do you combine two sequences eleme…](#08-projection-operations-q13)

- [09. Quantifier Operations](#09-quantifier-operations)
  - [Q1. What do `.All()`, `.Any()`, and `.Contains()` do, and when w…](#09-quantifier-operations-q1)
  - [Q2. What is the difference between `.Any(predicate)` and `.Where…](#09-quantifier-operations-q2)
  - [Q3. How does `.All()` behave on an empty sequence (vacuous truth…](#09-quantifier-operations-q3)
  - [Q4. What is the difference between `.Contains(item)` and `.Any(x…](#09-quantifier-operations-q4)
  - [Q5. How do quantifiers short-circuit enumeration?](#09-quantifier-operations-q5)
  - [Q6. How do quantifiers translate to SQL (`EXISTS`, `IN`, `ALL`) …](#09-quantifier-operations-q6)
  - [Q7. When is `.Contains` with a large in-memory list a performanc…](#09-quantifier-operations-q7)
  - [Q8. What is the difference between `.Any()` on `IQueryable` vs m…](#09-quantifier-operations-q8)
  - [Q9. How do quantifiers interact with null keys or null elements …](#09-quantifier-operations-q9)
  - [Q10. When should you prefer `.All()` vs validating with `.Count()…](#09-quantifier-operations-q10)
  - [Q11. What is `.SequenceEqual()`, and how does it compare sequence…](#09-quantifier-operations-q11)

- [10. Conversion Operations](#10-conversion-operations)
  - [Q1. When should you use `.ToList()`, `.ToArray()`, `.ToDictionar…](#10-conversion-operations-q1)
  - [Q2. What is `.ToLookup()` and when is it preferable to `.GroupBy…](#10-conversion-operations-q2)
  - [Q3. What are duplicate-key behaviors for `.ToDictionary()` vs `.…](#10-conversion-operations-q3)
  - [Q4. Why can calling `.ToList()` too early in an EF Core query hu…](#10-conversion-operations-q4)
  - [Q5. What is the difference between `.AsEnumerable()` and `.ToLis…](#10-conversion-operations-q5)
  - [Q6. What is `.Cast<T>()` vs `.OfType<T>()` — when does each thro…](#10-conversion-operations-q6)
  - [Q7. What is `.AsQueryable()` on an in-memory sequence — what pro…](#10-conversion-operations-q7)
  - [Q8. How do `.ToArray()` and `.ToList()` differ for subsequent mu…](#10-conversion-operations-q8)
  - [Q9. When should you use `.ToImmutableArray()` / `.ToImmutableLis…](#10-conversion-operations-q9)
  - [Q10. What is the cost of multiple conversions in a hot path?](#10-conversion-operations-q10)
  - [Q11. How does `.ToDictionary()` handle null keys?](#10-conversion-operations-q11)
  - [Q12. When is explicit materialization required before passing seq…](#10-conversion-operations-q12)

- [11. Partitioning Operations](#11-partitioning-operations)
  - [Q1. What is the difference between `.Take()`, `.Skip()`, `.TakeW…](#11-partitioning-operations-q1)
  - [Q2. How do `.Take`/`Skip` translate to SQL paging in EF Core?](#11-partitioning-operations-q2)
  - [Q3. What is `.Chunk()` (modern LINQ), and how does it differ fro…](#11-partitioning-operations-q3)
  - [Q4. What is the difference between `.TakeWhile`/`SkipWhile` vs `…](#11-partitioning-operations-q4)
  - [Q5. What are pitfalls of using `.Skip(n).Take(m)` without stable…](#11-partitioning-operations-q5)
  - [Q6. How does keyset (seek) pagination compare to offset paginati…](#11-partitioning-operations-q6)
  - [Q7. What happens when `Skip`/`Take` arguments are negative or la…](#11-partitioning-operations-q7)
  - [Q8. When does partitioning force full enumeration vs true stream…](#11-partitioning-operations-q8)
  - [Q9. How do partitioning operators interact with deferred executi…](#11-partitioning-operations-q9)
  - [Q10. How would you batch-process a large `IEnumerable<T>` using `…](#11-partitioning-operations-q10)
  - [Q11. What is `.TakeLast()` / `.SkipLast()`, and how do they diffe…](#11-partitioning-operations-q11)

- [12. Generation Operations](#12-generation-operations)
  - [Q1. What are `Enumerable.Range`, `Repeat`, and `Empty` used for?](#12-generation-operations-q1)
  - [Q2. What is the difference between `Enumerable.Repeat` and repea…](#12-generation-operations-q2)
  - [Q3. How do generation methods behave with deferred execution?](#12-generation-operations-q3)
  - [Q4. When is `Enumerable.Empty<T>()` preferable to `Array.Empty<T…](#12-generation-operations-q4)
  - [Q5. How do you generate sequences lazily without preallocating l…](#12-generation-operations-q5)
  - [Q6. What are pitfalls of `Range` with large counts (memory, over…](#12-generation-operations-q6)
  - [Q7. How do generation operators combine with `.Select` to produc…](#12-generation-operations-q7)
  - [Q8. When would you use `yield return` in custom iterators vs `En…](#12-generation-operations-q8)
  - [Q9. How do infinite or unbounded sequences interact with operato…](#12-generation-operations-q9)
  - [Q10. What is the difference between generating sequences in LINQ …](#12-generation-operations-q10)

- [13. LINQ to XML](#13-linq-to-xml)
  - [Q1. What is the difference between LINQ to XML (`XDocument`, `XE…](#13-linq-to-xml-q1)
  - [Q2. How do you load, create, and mutate XML with `XDocument` and…](#13-linq-to-xml-q2)
  - [Q3. How do you query XML with LINQ (`Descendants`, `Elements`, `…](#13-linq-to-xml-q3)
  - [Q4. What is the difference between `Elements()` and `Descendants…](#13-linq-to-xml-q4)
  - [Q5. How do you project XML into CLR objects manually vs using de…](#13-linq-to-xml-q5)
  - [Q6. What is the difference between `XElement` and `XAttribute` i…](#13-linq-to-xml-q6)
  - [Q7. How do namespaces affect LINQ to XML queries (`XNamespace`, …](#13-linq-to-xml-q7)
  - [Q8. When should you use `XmlReader` streaming vs LINQ to XML DOM…](#13-linq-to-xml-q8)
  - [Q9. How do you handle malformed XML and exceptions in LINQ to XM…](#13-linq-to-xml-q9)
  - [Q10. What are performance and memory considerations for large XML…](#13-linq-to-xml-q10)
  - [Q11. How do you transform XML shape with functional-style project…](#13-linq-to-xml-q11)
  - [Q12. What is the difference between `XDocument.Save` formatting o…](#13-linq-to-xml-q12)
  - [Q13. **Multiple enumeration** — Deferred queries re-run on each `…](#13-linq-to-xml-q13)
  - [Q14. **`.ToList()` too early with EF Core** — Materializing befor…](#13-linq-to-xml-q14)
  - [Q15. **Unstable paging** — `.Skip`/`Take` without `OrderBy` yield…](#13-linq-to-xml-q15)
  - [Q16. **Double `OrderBy`** — Second `OrderBy` replaces the first s…](#13-linq-to-xml-q16)
  - [Q17. **`.Single()` vs `.First()`** — `.Single()` throws on zero *…](#13-linq-to-xml-q17)
  - [Q18. **Closure over loop variable in LINQ** — `.Where(x => x.Id =…](#13-linq-to-xml-q18)
  - [Q19. **`.Count()` cost** — O(1) on `ICollection<T>`; O(n) when th…](#13-linq-to-xml-q19)
  - [Q20. **Set operators and comparers** — Without explicit `IEqualit…](#13-linq-to-xml-q20)
  - [Q21. **`GroupBy` vs `ToLookup` timing** — `GroupBy` is deferred; …](#13-linq-to-xml-q21)
  - [Q22. **Client evaluation surprises** — Custom CLR methods in `Whe…](#13-linq-to-xml-q22)
...
#### Q1. What is LINQ, and what problem does it unify across in-memory collections, databases, XML, and more? {#01-introduction-to-linq-q1}
...
#### Q2. What is the difference between query syntax and method syntax? Are they equivalent? {#01-introduction-to-linq-q2}
...
#### Q3. What is deferred execution in LINQ, and which operators break it? {#01-introduction-to-linq-q3}
...
#### Q4. What is the difference between deferred execution and lazy evaluation? {#01-introduction-to-linq-q4}
...
#### Q5. What is the difference between `IEnumerable<T>` and `IQueryable<T>`? {#01-introduction-to-linq-q5}
...
#### Q6. What is an expression tree, and why does `IQueryable` depend on it? {#01-introduction-to-linq-q6}
...
#### Q7. What is the difference between LINQ to Objects and LINQ to Entities (EF Core)? {#01-introduction-to-linq-q7}

_Answer not found._

---

#### Q8. What is the role of the `Enumerable` vs `Queryable` static classes? {#01-introduction-to-linq-q8}

_Answer not found._

---

#### Q9. What does it mean for a LINQ provider to translate a query? What happens when translation fails? {#01-introduction-to-linq-q9}

_Answer not found._

---

#### Q10. How do you inspect or debug the SQL generated by an `IQueryable` provider? {#01-introduction-to-linq-q10}

_Answer not found._

---

#### Q11. What is the difference between chaining LINQ operators vs building queries incrementally with `if` conditions? {#01-introduction-to-linq-q11}

_Answer not found._

---

#### Q12. What are common signs that LINQ is hurting readability, and how do you refactor without losing composability? {#01-introduction-to-linq-q12}

_Answer not found._

---

#### Q13. How does LINQ interact with nullable reference types and null propagation in projections? {#01-introduction-to-linq-q13}

_Answer not found._

---

#### Q14. What is query rewriting (e.g., `let`, `join`, `group` in query syntax) at a high level? {#01-introduction-to-linq-q14}
...
#### Q1. What is the difference between `.Where()` and `.Select()` in intent and output shape? {#02-filtering-aggregation-q1}
...
#### Q2. When should you filter before projecting vs project before filtering? {#02-filtering-aggregation-q2}
...
#### Q3. What is the difference between `.Count()`, `.LongCount()`, `.Sum()`, `.Average()`, `.Min()`, and `.Max()`? {#02-filtering-aggregation-q3}
...
#### Q4. What happens when `.Average()` or `.Sum()` is called on an empty sequence? {#02-filtering-aggregation-q4}
...
#### Q5. What is `.Aggregate()`, and how does it generalize other aggregations? {#02-filtering-aggregation-q5}
...
#### Q6. How do seed and accumulator overloads of `.Aggregate()` work? Give use cases (running totals, building strings, merging objects). {#02-filtering-aggregation-q6}
...
#### Q7. What is the difference between `.Aggregate()` with and without a result selector? {#02-filtering-aggregation-q7}

_Answer not found._

---

#### Q8. What is `.Count(predicate)` vs `.Where().Count()` in terms of readability and performance? {#02-filtering-aggregation-q8}

_Answer not found._

---

#### Q9. What is the difference between `.Any()` and `.Count() > 0` for `IEnumerable<T>` vs `ICollection<T>`? {#02-filtering-aggregation-q9}

_Answer not found._

---

#### Q10. How do nullable numeric aggregations behave in LINQ to Objects? {#02-filtering-aggregation-q10}

_Answer not found._

---

#### Q11. What is the difference between `.Sum()` on `int` vs `long` vs `decimal` regarding overflow? {#02-filtering-aggregation-q11}

_Answer not found._

---

#### Q12. How do aggregations translate (or fail to translate) in LINQ to Entities? {#02-filtering-aggregation-q12}

_Answer not found._

---

#### Q13. When would you use `.Aggregate()` instead of a simple loop for custom accumulation logic? {#02-filtering-aggregation-q13}

_Answer not found._

---

#### Q14. What are pitfalls of aggregating floating-point values from large sequences? {#02-filtering-aggregation-q14}
...
#### Q1. What is the difference between `OrderBy().ThenBy()` and calling `OrderBy()` twice? {#03-ordering-q1}
...
#### Q2. What is stable sort in LINQ to Objects, and why does it matter? {#03-ordering-q2}
...
#### Q3. Does `OrderBy` guarantee stability across all .NET versions and providers? {#03-ordering-q3}
...
#### Q4. What is the difference between `OrderBy` and `OrderByDescending` when keys compare equal? {#03-ordering-q4}
...
#### Q7. What is the difference between sorting before `GroupBy` vs sorting groups with `OrderBy` on the outer sequence? {#03-ordering-q7}
...
#### Q10. How does ordering translate to SQL in EF Core (`ORDER BY`, composite keys)? {#03-ordering-q10}

_Answer not found._

---

#### Q11. What is the performance characteristic of `OrderBy` in LINQ to Objects? {#03-ordering-q11}

_Answer not found._

---

#### Q12. What happens if the key selector throws for some elements during ordering? {#03-ordering-q12}

_Answer not found._

---

#### Q13. How do `OrderBy` and `Reverse()` interact — does `Reverse` undo sort stability semantics? {#03-ordering-q13}

_Answer not found._

---

#### Q14. When is in-memory sorting the wrong choice for large EF Core queries? {#03-ordering-q14}
...
#### Q1. Explain `GroupBy` in LINQ to Objects — what is the shape of the result? {#04-grouping-q1}
...
#### Q2. What is the difference between `GroupBy(keySelector)` and `GroupBy(keySelector, elementSelector)`? {#04-grouping-q2}
...
#### Q3. What is the difference between `GroupBy` with a result selector vs post-processing grouped sequences? {#04-grouping-q3}
...
#### Q4. How does `GroupBy` differ when translated to SQL (LINQ to Entities) vs in-memory? {#04-grouping-q4}
...
#### Q6. When should you use `ToLookup()` instead of `GroupBy().ToDictionary()`? {#04-grouping-q6}
...
#### Q7. What is `ILookup<TKey, TElement>` and how is it immutable compared to `Dictionary` of lists? {#04-grouping-q7}

_Answer not found._

---

#### Q8. How do you group by composite keys (anonymous types, value tuples, custom key types)? {#04-grouping-q8}

_Answer not found._

---

#### Q9. How does key equality affect grouping (`Equals`/`GetHashCode`, reference vs value semantics)? {#04-grouping-q9}

_Answer not found._

---

#### Q10. What is the difference between `group by` in query syntax and method syntax? {#04-grouping-q10}
...
#### Q12. What are common mistakes grouping large EF Core queries (client evaluation, pulling too much data)? {#04-grouping-q12}

_Answer not found._

---

#### Q13. How does `GroupBy` interact with ordering of elements within each group? {#04-grouping-q13}

_Answer not found._

---

#### Q14. When would you prefer `Dictionary` manual grouping over `GroupBy` for performance? {#04-grouping-q14}
...
#### Q1. What is the difference between inner join, left join, and cross join in LINQ? {#05-joins-q1}
...
#### Q2. How do you express a left outer join in method syntax vs query syntax? {#05-joins-q2}
...
#### Q4. When should you use `GroupJoin` followed by `SelectMany` vs a direct `join`? {#05-joins-q4}
...
#### Q5. How do you join on composite keys using anonymous types or tuples? {#05-joins-q5}
...
#### Q7. What is the difference between equijoin and non-equijoin — can LINQ express non-equijoins cleanly? {#05-joins-q7}
...
#### Q8. How do joins translate to SQL in EF Core (`INNER JOIN`, `LEFT JOIN`)? {#05-joins-q8}
...
#### Q10. What performance pitfalls appear when joining large in-memory sequences vs database-side joins? {#05-joins-q10}
...
#### Q12. What is the difference between a join and a correlated subquery in LINQ query syntax? {#05-joins-q12}

_Answer not found._

---

#### Q13. When is `Join` preferable to building a `Dictionary` lookup manually? {#05-joins-q13}

_Answer not found._

---

#### Q14. What happens when duplicate keys exist on the inner or outer sequence? {#05-joins-q14}
...
#### Q1. What is the difference between `.First()`, `.FirstOrDefault()`, `.Single()`, and `.SingleOrDefault()` — when does each throw? {#06-element-operations-q1}
...
#### Q2. What is the difference between `.Last()` and `.LastOrDefault()` on deferred vs indexed sequences? {#06-element-operations-q2}
...
#### Q3. What is the difference between `.ElementAt(index)` and indexing (`list[index]`)? {#06-element-operations-q3}
...
#### Q4. What is `.ElementAtOrDefault()` behavior for out-of-range indexes? {#06-element-operations-q4}
...
#### Q5. How do element operations behave on empty sequences for each overload? {#06-element-operations-q5}
...
#### Q6. What is the difference between `.First(predicate)` vs `.Where(predicate).First()`? {#06-element-operations-q6}
...
#### Q8. What is the time complexity of `.ElementAt()` on a linked list vs `IList<T>`? {#06-element-operations-q8}

_Answer not found._

---

#### Q9. When should you use `.FirstOrDefault()` vs `.SingleOrDefault()` defensively in APIs? {#06-element-operations-q9}
...
#### Q11. What exceptions are thrown vs null/default returned for reference and value types? {#06-element-operations-q11}

_Answer not found._

---

#### Q12. How do `.MinBy()` / `.MaxBy()` (modern LINQ) relate to element operations conceptually? {#06-element-operations-q12}
...
#### Q1. What is the difference between `.Distinct()`, `.Union()`, `.Intersect()`, and `.Except()`? {#07-set-operations-q1}
...
#### Q3. What is `.DistinctBy()` (modern LINQ), and how does it differ from `.GroupBy().Select(g => g.First())`? {#07-set-operations-q3}
...
#### Q4. Are `Union`/`Intersect`/`Except` multisets or sets — how are duplicate inputs handled? {#07-set-operations-q4}
...
#### Q5. What is the difference between `.Union()` and `.Concat().Distinct()`? {#07-set-operations-q5}
...
#### Q7. What is the performance of set operations on sorted vs unsorted inputs? {#07-set-operations-q7}

_Answer not found._

---

#### Q8. When would you use `HashSet<T>` manually instead of LINQ set operators? {#07-set-operations-q8}

_Answer not found._

---

#### Q9. How do reference equality and value equality change set operation results? {#07-set-operations-q9}

_Answer not found._

---

#### Q10. What is the difference between set operations on in-memory sequences vs `IQueryable`? {#07-set-operations-q10}
...
#### Q2. When should you use `.SelectMany()` for one-to-many relationships? {#08-projection-operations-q2}
...
#### Q3. What is projection to anonymous types vs named DTOs — trade-offs for maintenance and testing? {#08-projection-operations-q3}
...
#### Q5. What is the difference between `.Select()` before vs after `.Where()` for EF Core translation? {#08-projection-operations-q5}
...
#### Q7. What is a selector that returns `IEnumerable<T>` vs flattened `SelectMany`? {#08-projection-operations-q7}
...
#### Q9. What are common causes of N+1 queries related to projection in EF Core? {#08-projection-operations-q9}

_Answer not found._

---

#### Q10. How does `let` in query syntax relate to projection and intermediate variables? {#08-projection-operations-q10}

_Answer not found._

---

#### Q11. When does projection cause full entity materialization vs column slicing in SQL? {#08-projection-operations-q11}

_Answer not found._

---

#### Q12. What is the difference between projecting computed values vs mapping existing properties only? {#08-projection-operations-q12}

_Answer not found._

---

#### Q13. What is `.Zip()`, and how do you combine two sequences element-by-element (including unequal lengths)? {#08-projection-operations-q13}
...
#### Q1. What do `.All()`, `.Any()`, and `.Contains()` do, and when would you use each? {#09-quantifier-operations-q1}
...
#### Q2. What is the difference between `.Any(predicate)` and `.Where(predicate).Any()`? {#09-quantifier-operations-q2}
...
#### Q4. What is the difference between `.Contains(item)` and `.Any(x => x.Equals(item))` with custom equality? {#09-quantifier-operations-q4}
...
#### Q6. How do quantifiers translate to SQL (`EXISTS`, `IN`, `ALL`) in EF Core? {#09-quantifier-operations-q6}
...
#### Q7. When is `.Contains` with a large in-memory list a performance problem for EF Core? {#09-quantifier-operations-q7}

_Answer not found._

---

#### Q8. What is the difference between `.Any()` on `IQueryable` vs materialized collections? {#09-quantifier-operations-q8}

_Answer not found._

---

#### Q9. How do quantifiers interact with null keys or null elements in sequences? {#09-quantifier-operations-q9}

_Answer not found._

---

#### Q10. When should you prefer `.All()` vs validating with `.Count()` or exceptions? {#09-quantifier-operations-q10}

_Answer not found._

---

#### Q11. What is `.SequenceEqual()`, and how does it compare sequences with optional `IEqualityComparer<T>`? {#09-quantifier-operations-q11}
...
#### Q1. When should you use `.ToList()`, `.ToArray()`, `.ToDictionary()`, `.ToHashSet()`, and `.AsEnumerable()`? {#10-conversion-operations-q1}
...
#### Q2. What is `.ToLookup()` and when is it preferable to `.GroupBy().ToDictionary()`? {#10-conversion-operations-q2}
...
#### Q3. What are duplicate-key behaviors for `.ToDictionary()` vs `.ToLookup()`? {#10-conversion-operations-q3}
...
#### Q4. Why can calling `.ToList()` too early in an EF Core query hurt performance? {#10-conversion-operations-q4}
...
#### Q5. What is the difference between `.AsEnumerable()` and `.ToList()` for switching from `IQueryable` to LINQ to Objects? {#10-conversion-operations-q5}
...
#### Q6. What is `.Cast<T>()` vs `.OfType<T>()` — when does each throw vs filter? {#10-conversion-operations-q6}
...
#### Q7. What is `.AsQueryable()` on an in-memory sequence — what provider backs it? {#10-conversion-operations-q7}

_Answer not found._

---

#### Q8. How do `.ToArray()` and `.ToList()` differ for subsequent mutations and memory? {#10-conversion-operations-q8}

_Answer not found._

---

#### Q9. When should you use `.ToImmutableArray()` / `.ToImmutableList()` from System.Collections.Immutable? {#10-conversion-operations-q9}
...
#### Q12. When is explicit materialization required before passing sequences across async boundaries? {#10-conversion-operations-q12}
...
#### Q1. What is the difference between `.Take()`, `.Skip()`, `.TakeWhile()`, and `.SkipWhile()`? {#11-partitioning-operations-q1}
...
#### Q3. What is `.Chunk()` (modern LINQ), and how does it differ from manual batching loops? {#11-partitioning-operations-q3}
...
#### Q4. What is the difference between `.TakeWhile`/`SkipWhile` vs `.Where` for conditional paging? {#11-partitioning-operations-q4}
...
#### Q5. What are pitfalls of using `.Skip(n).Take(m)` without stable ordering in databases? {#11-partitioning-operations-q5}
...
#### Q6. How does keyset (seek) pagination compare to offset pagination in LINQ/EF? {#11-partitioning-operations-q6}
...
#### Q7. What happens when `Skip`/`Take` arguments are negative or larger than the sequence? {#11-partitioning-operations-q7}

_Answer not found._

---

#### Q8. When does partitioning force full enumeration vs true streaming? {#11-partitioning-operations-q8}

_Answer not found._

---

#### Q9. How do partitioning operators interact with deferred execution? {#11-partitioning-operations-q9}

_Answer not found._

---

#### Q10. How would you batch-process a large `IEnumerable<T>` using `.Chunk()` for database updates? {#11-partitioning-operations-q10}

_Answer not found._

---

#### Q11. What is `.TakeLast()` / `.SkipLast()`, and how do they differ from reversing then taking? {#11-partitioning-operations-q11}
...
#### Q2. What is the difference between `Enumerable.Repeat` and repeating elements in a collection? {#12-generation-operations-q2}
...
#### Q4. When is `Enumerable.Empty<T>()` preferable to `Array.Empty<T>()` or `new List<T>()`? {#12-generation-operations-q4}
...
#### Q5. How do you generate sequences lazily without preallocating large arrays? {#12-generation-operations-q5}
...
#### Q6. What are pitfalls of `Range` with large counts (memory, overflow)? {#12-generation-operations-q6}
...
#### Q7. How do generation operators combine with `.Select` to produce synthetic keys or indexes? {#12-generation-operations-q7}

_Answer not found._

---

#### Q8. When would you use `yield return` in custom iterators vs `Enumerable.Range`? {#12-generation-operations-q8}

_Answer not found._

---

#### Q9. How do infinite or unbounded sequences interact with operators like `.Count()` or `.Take()`? {#12-generation-operations-q9}

_Answer not found._

---

#### Q10. What is the difference between generating sequences in LINQ vs using `Random` or GUID factories in projections? {#12-generation-operations-q10}
...
#### Q1. What is the difference between LINQ to XML (`XDocument`, `XElement`) and XML serialization (`XmlSerializer`, `DataContractSerializer`)? {#13-linq-to-xml-q1}
...
#### Q2. How do you load, create, and mutate XML with `XDocument` and `XElement`? {#13-linq-to-xml-q2}
...
#### Q3. How do you query XML with LINQ (`Descendants`, `Elements`, `Attributes`, `XPath` extensions)? {#13-linq-to-xml-q3}
...
#### Q5. How do you project XML into CLR objects manually vs using deserialization? {#13-linq-to-xml-q5}
...
#### Q6. What is the difference between `XElement` and `XAttribute` in queries? {#13-linq-to-xml-q6}
...
#### Q7. How do namespaces affect LINQ to XML queries (`XNamespace`, `XName.Get`)? {#13-linq-to-xml-q7}

_Answer not found._

---

#### Q8. When should you use `XmlReader` streaming vs LINQ to XML DOM-style loading? {#13-linq-to-xml-q8}

_Answer not found._

---

#### Q9. How do you handle malformed XML and exceptions in LINQ to XML pipelines? {#13-linq-to-xml-q9}

_Answer not found._

---

#### Q10. What are performance and memory considerations for large XML documents with LINQ to XML? {#13-linq-to-xml-q10}

_Answer not found._

---

#### Q11. How do you transform XML shape with functional-style projections? {#13-linq-to-xml-q11}

_Answer not found._

---

#### Q12. What is the difference between `XDocument.Save` formatting options and writer-based output? {#13-linq-to-xml-q12}

_Answer not found._

---

#### Q13. **Multiple enumeration** — Deferred queries re-run on each `foreach`; dangerous with DB connections, file streams, or random sources. {#13-linq-to-xml-q13}

_Answer not found._

---

#### Q14. **`.ToList()` too early with EF Core** — Materializing before filtering/projects entire tables into memory. {#13-linq-to-xml-q14}

_Answer not found._

---

#### Q15. **Unstable paging** — `.Skip`/`Take` without `OrderBy` yields nondeterministic pages in SQL. {#13-linq-to-xml-q15}

_Answer not found._

---

#### Q16. **Double `OrderBy`** — Second `OrderBy` replaces the first sort key; use `ThenBy` for secondary keys. {#13-linq-to-xml-q16}

_Answer not found._

---

#### Q17. **`.Single()` vs `.First()`** — `.Single()` throws on zero *or* more than one match; easy to misuse on filtered data. {#13-linq-to-xml-q17}

_Answer not found._

---

#### Q18. **Closure over loop variable in LINQ** — `.Where(x => x.Id == ids[i])` inside a loop captures the wrong index/value. {#13-linq-to-xml-q18}

_Answer not found._

---

#### Q19. **`.Count()` cost** — O(1) on `ICollection<T>`; O(n) when the sequence must be fully walked. {#13-linq-to-xml-q19}

_Answer not found._

---

#### Q20. **Set operators and comparers** — Without explicit `IEqualityComparer`, reference types may not dedupe as expected. {#13-linq-to-xml-q20}

_Answer not found._

---

#### Q21. **`GroupBy` vs `ToLookup` timing** — `GroupBy` is deferred; `ToLookup` executes immediately and is immutable. {#13-linq-to-xml-q21}

_Answer not found._

---

#### Q22. **Client evaluation surprises** — Custom CLR methods in `Where`/`Select` may pull data client-side silently or fail translation in strict EF Core mode. {#13-linq-to-xml-q22}
