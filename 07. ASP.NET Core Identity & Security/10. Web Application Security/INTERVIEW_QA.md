...
## Table of Contents
1. [What is the OWASP Top 10, and which categories are most relevant to ASP.NET Core…](#q1)
2. [What is Cross-Site Scripting (XSS), and what are the three main types?](#q2)
3. [How does ASP.NET Core protect against XSS by default, and when does that protect…](#q3)
4. [What is Cross-Site Request Forgery (CSRF), and how does an attacker exploit it?](#q4)
5. [How do anti-forgery tokens work in ASP.NET Core, and what are the two primary AP…](#q5)
6. [What is SQL injection, and how does EF Core protect against it by default?](#q6)
7. [When using EF Core, can raw SQL queries still be vulnerable to SQL injection? Ho…](#q7)
8. [What is an Insecure Direct Object Reference (IDOR), and how does proper authoriz…](#q8)
9. [What is Content Security Policy (CSP), and how do you add it to an ASP.NET Core …](#q9)
10. [What HTTP security headers should every ASP.NET Core application include, and wh…](#q10)
11. [What is HTTP Strict Transport Security (HSTS), and how do you enable it in ASP.N…](#q11)
12. [What is CORS (Cross-Origin Resource Sharing), and why does the browser enforce i…](#q12)
13. [How do you configure a CORS policy in ASP.NET Core, and what is the difference b…](#q13)
14. [What is a CORS preflight request, and when does the browser send one?](#q14)
15. [Why is CORS not a server-side security boundary?](#q15)
16. [What is an open redirect vulnerability, and how do ASP.NET Core's `LocalRedirect…](#q16)
17. [What are the `Secure`, `HttpOnly`, and `SameSite` cookie attributes, and what th…](#q17)
18. [What are the valid values of the `SameSite` cookie attribute, and how does each …](#q18)
19. [What is the `SameSite=None` gotcha, and when does it apply?](#q19)
20. [How does ASP.NET Core's cookie authentication middleware configure cookies secur…](#q20)
21. [What is rate limiting, and how do you add it to an ASP.NET Core application (.NE…](#q21)
22. [What rate-limiting algorithms are built into `Microsoft.AspNetCore.RateLimiting`…](#q22)
23. [What is input validation, and how does ASP.NET Core model binding contribute to …](#q23)
24. [What is the difference between client-side and server-side input validation, and…](#q24)
25. [What is a mass assignment vulnerability, and how do `[Bind]` and dedicated DTOs …](#q25)
26. [What are stored XSS and reflected XSS, and which is more dangerous and why?](#q26)
27. [How does DOM-based XSS differ from server-side XSS, and what mitigation applies?](#q27)
28. [What is the difference between authentication and authorization, and why does co…](#q28)
