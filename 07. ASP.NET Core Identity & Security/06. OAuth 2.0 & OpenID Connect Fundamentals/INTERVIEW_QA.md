...
## Table of Contents
1. [What problem does OAuth 2.0 solve, and why is it described as a delegated author…](#q1)
2. [What are the four roles defined in OAuth 2.0, and what is each role responsible …](#q2)
3. [What is the difference between the Authorization Server and the Resource Server …](#q3)
4. [What is the Authorization Code grant type, and when should it be used?](#q4)
5. [Walk through the Authorization Code flow step by step, including every redirect …](#q5)
6. [What is PKCE (Proof Key for Code Exchange), and what attack does it prevent?](#q6)
7. [How does PKCE work mechanically — what is the code verifier, the code challenge,…](#q7)
8. [What is the Client Credentials grant type, and when is it the appropriate choice…](#q8)
9. [What is the Device Code grant type, and what problem does it address?](#q9)
10. [Why are the Implicit grant and Resource Owner Password Credentials (ROPC) grant …](#q10)
11. [What is an Access Token, and what information does it convey to the Resource Ser…](#q11)
12. [What is a Refresh Token, and how does it differ from an Access Token in lifetime…](#q12)
13. [What is an ID Token, and why does OpenID Connect introduce it when OAuth 2.0 alr…](#q13)
14. [What is the structure of a JSON Web Token (JWT), and what does each part contain…](#q14)
15. [How is a JWT signed, and how does a Resource Server or client verify that signat…](#q15)
16. [What is OpenID Connect (OIDC), and how does it relate to OAuth 2.0?](#q16)
17. [What is the fundamental difference between OAuth 2.0 and OpenID Connect in terms…](#q17)
18. [What OIDC scopes are defined by the specification, and what claims does each sco…](#q18)
19. [What is the UserInfo endpoint in OIDC, and when would a client call it instead o…](#q19)
20. [What is the OpenID Connect discovery document, where is it found, and what infor…](#q20)
21. [What validations must a client perform on a received ID Token before trusting it…](#q21)
22. [What validations should a Resource Server perform on an Access Token (JWT format…](#q22)
23. [What is the nonce parameter in OIDC, and what attack does it prevent?](#q23)
24. [What is token introspection, and when is it used instead of local JWT validation…](#q24)
25. [What is token revocation, and why does it matter for short-lived versus long-liv…](#q25)
26. [What is the difference between the front channel and the back channel in an OAut…](#q26)
27. [How does an Authorization Code flow with PKCE differ from the original Authoriza…](#q27)
28. [Can an OAuth 2.0 Access Token alone be used to authenticate a user — that is, to…](#q28)
