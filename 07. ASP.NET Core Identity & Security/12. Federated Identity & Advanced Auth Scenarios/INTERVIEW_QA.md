...
## Table of Contents
1. [What is federated identity, and why is it useful in enterprise environments?](#q1)
2. [What is the difference between an Identity Provider (IdP) and a Service Provider…](#q2)
3. [How does SAML 2.0 differ from OpenID Connect (OIDC) / OAuth 2.0 at a high level,…](#q3)
4. [What role does Azure Active Directory (now Microsoft Entra ID) play as an IdP in…](#q4)
5. [How does the `Microsoft.Identity.Web` library simplify integrating Azure AD auth…](#q5)
6. [What is a multi-tenant application in Azure AD, and how does token validation di…](#q6)
7. [How do you validate tokens from multiple tenants safely in ASP.NET Core without …](#q7)
8. [What is the On-Behalf-Of (OBO) flow, and when would you use it in a microservice…](#q8)
9. [How does the Client Credentials flow work, and when is it appropriate for machin…](#q9)
10. [What is token chaining in a microservices architecture, and what risks does it i…](#q10)
11. [What is the Backend for Frontend (BFF) pattern, and why is it used to secure Sin…](#q11)
12. [What is Duende IdentityServer, and when would you self-host an authorization ser…](#q12)
13. [What is OpenIddict, and how does it compare to Duende IdentityServer as a self-h…](#q13)
14. [What is dynamic client registration (DCR) in OAuth 2.0, and when is it useful?](#q14)
15. [How do scopes work in a microservices architecture with per-service audiences?](#q15)
16. [What is the difference between the `aud` (audience) claim and the `scope` claim …](#q16)
17. [What is silent token refresh in a SPA, and how does it work with OIDC?](#q17)
18. [What is OIDC Session Management, and how does it differ from silent token refres…](#q18)
19. [What is the OAuth 2.0 token revocation endpoint, and how does it work?](#q19)
20. [What is the token introspection endpoint, and when should you use it instead of …](#q20)
21. [What are the security considerations for using the implicit grant flow versus th…](#q21)
22. [What is the difference between delegated permissions and application permissions…](#q22)
23. [How do you achieve tenant isolation in a multi-tenant application to prevent cro…](#q23)
24. [What is PKCE (Proof Key for Code Exchange), and why was it introduced in OAuth 2…](#q24)
25. [What is a federated credential, and how is it used in Azure Workload Identity or…](#q25)
26. [What are the common security risks in token forwarding (token chaining) across m…](#q26)
27. [What is claims transformation in ASP.NET Core, and when is it useful in federate…](#q27)
28. [How does the BFF pattern compare to storing tokens in browser-accessible storage…](#q28)
