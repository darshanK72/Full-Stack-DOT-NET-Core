...
## Table of Contents
1. [What is Azure Cache for Redis, and why would an ASP.NET Core application use it …](#q1)
2. [How does Azure Cache for Redis relate to open-source Redis, and what does Micros…](#q2)
3. [What problems does a distributed cache solve that an in-process cache (`IMemoryC…](#q3)
4. [Compare `IMemoryCache` and `IDistributedCache` — when would you use each, and ca…](#q4)
5. [What are the most common caching use cases for Azure Cache for Redis in ASP.NET …](#q5)
6. [What is the cache-aside (lazy loading) pattern, and walk through the read and wr…](#q6)
7. [What is write-through caching, and when is it preferable to cache-aside?](#q7)
8. [What is write-behind (write-back) caching, and what consistency risks does it in…](#q8)
9. [What is cache stampede (thundering herd), and how do you prevent it in a .NET ap…](#q9)
10. [When should you avoid caching data, and what types of data are poor cache candid…](#q10)
11. [How do you handle cache invalidation when the authoritative source (database or …](#q11)
12. [How do you register Azure Cache for Redis as `IDistributedCache` in ASP.NET Core…](#q12)
13. [What is the difference between `AddStackExchangeRedisCache` and using `Connectio…](#q13)
14. [How does `IDistributedCache` serialize values, and what constraints does that pl…](#q14)
15. [How do you configure absolute and sliding expiration with `DistributedCacheEntry…](#q15)
16. [How does distributed caching differ from ASP.NET Core output caching and respons…](#q16)
17. [What is `ConnectionMultiplexer` in StackExchange.Redis, and why should you regis…](#q17)
18. [Beyond simple string key-value pairs, what Redis data structures does StackExcha…](#q18)
19. [How do you implement a distributed lock with Redis, and what pitfalls exist with…](#q19)
20. [What is Redis pub/sub, and how is it used in .NET (for example SignalR backplane…](#q20)
21. [How should a production ASP.NET Core app handle Redis connection failures, timeo…](#q21)
22. [What is TTL (time-to-live) in Redis, and how do you choose expiration values for…](#q22)
23. [What are the Azure Cache for Redis tiers (Basic, Standard, Premium, and Enterpri…](#q23)
24. [What high-availability and scaling options does Azure Cache for Redis offer (rep…](#q24)
25. [How do you configure ASP.NET Core session state to use Redis as the distributed …](#q25)
26. [What security features does Azure Cache for Redis provide (TLS, access keys, fir…](#q26)
27. [What monitoring, alerting, and troubleshooting practices apply to Azure Cache fo…](#q27)
