...
namespace AzureSQLWebApplication.Models;

public partial class Db46310114Context : DbContext
{
    public Db46310114Context()
    {
    }

    public Db46310114Context(DbContextOptions<Db46310114Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:server46310114.database.windows.net,1433;Initial Catalog=db46310114;Persist Security Info=False;User ID=rootuser;Password=Darshan123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA26D1CFE4");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__F9B8346D011283FB");
