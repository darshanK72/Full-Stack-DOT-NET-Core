...
## Table of Contents
1. [What is Azure App Service, and why is it a common target for hosting ASP.NET Cor…](#q1)
2. [What is the relationship between an App Service Plan, an App Service app, and a …](#q2)
3. [What does the `kind: "app"` setting on a Web App mean in Azure?](#q3)
4. [How does Azure App Service run an ASP.NET Core Web API — what runtime and web se…](#q4)
5. [What is the role of `AllowedHosts` in `appsettings.json` when the API is deploye…](#q5)
6. [What deployment options are available for ASP.NET Core Web APIs on Azure App Ser…](#q6)
7. [What is Zip Deploy, and how does it work for ASP.NET Core applications?](#q7)
8. [What is Web Deploy (MSDeploy), and when would you choose it over Zip Deploy?](#q8)
9. [What does `dotnet publish` produce, and how does that output relate to Azure dep…](#q9)
10. [How does publish-from-Visual Studio work using a publish profile and service dep…](#q10)
11. [What is Run From Package (`WEBSITE_RUN_FROM_PACKAGE`), and why would you enable …](#q11)
12. [How do Azure App Service Application Settings map to ASP.NET Core configuration?](#q12)
13. [Why should production secrets and connection strings not remain in `appsettings.…](#q13)
14. [What is the difference between Connection Strings and Application Settings in th…](#q14)
15. [What does the `ASPNETCORE_ENVIRONMENT` variable control when the API runs on Azu…](#q15)
16. [How does `launchSettings.json` differ from production configuration on Azure App…](#q16)
17. [What is Azure Service Connector (Service Linker), and how does it relate to `ser…](#q17)
18. [How does Entity Framework Core resolve the SQL Server connection string when thi…](#q18)
19. [What firewall and networking rules are typically required for Azure SQL Database…](#q19)
20. [How are EF Core migrations applied to an Azure SQL database as part of deploymen…](#q20)
21. [What do the `Properties/ServiceDependencies/` ARM templates and publish profile …](#q21)
22. [What are deployment slots in Azure App Service, and how do they support safer re…](#q22)
23. [What is slot swapping, and which settings are swapped versus marked as slot-stic…](#q23)
24. [How would you set up a basic CI/CD pipeline to build and deploy this Web API to …](#q24)
25. [What is the difference between a staging slot and a separate staging App Service…](#q25)
26. [Why is `httpsOnly: true` on an App Service important, and how does it relate to …](#q26)
27. [What production concerns arise when Swagger is enabled in a deployed API (as in …](#q27)
28. [Gotcha: Why can a locally working API fail on Azure with database connection err…](#q28)
