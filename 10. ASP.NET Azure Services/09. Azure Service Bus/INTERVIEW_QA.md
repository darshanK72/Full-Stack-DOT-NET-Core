...
## Table of Contents
1. [What is Azure Service Bus, and why would an ASP.NET Core application use it inst…](#q1)
2. [What is the difference between the Standard and Premium messaging tiers in Azure…](#q2)
3. [What is the difference between a queue and a topic with subscriptions in Azure S…](#q3)
4. [What are namespaces and entities in Azure Service Bus, and how are they organize…](#q4)
5. [How does Azure Service Bus differ from Azure Event Hubs and Azure Event Grid?](#q5)
6. [How does message delivery work on a Service Bus queue, and what competing consum…](#q6)
7. [How does fan-out messaging work with topics and subscriptions, and how is it dif…](#q7)
8. [What are subscription filter rules (SQL filters and correlation filters), and wh…](#q8)
9. [What is auto-forwarding in Azure Service Bus, and when is it useful?](#q9)
10. [What is message scheduling (scheduled enqueue time) in Azure Service Bus, and wh…](#q10)
11. [What is the difference between PeekLock and ReceiveAndDelete receive modes?](#q11)
12. [What is a message lock, and what happens when a consumer does not complete or ab…](#q12)
13. [What delivery semantics does Azure Service Bus provide — at-most-once, at-least-…](#q13)
14. [What is duplicate detection in Azure Service Bus, and how do you configure it on…](#q14)
15. [What is message deferral in Azure Service Bus, and when would you defer a messag…](#q15)
16. [What are Service Bus message sessions, and how do they enable ordered processing…](#q16)
17. [How does ServiceBusSessionProcessor work in Azure.Messaging.ServiceBus for sessi…](#q17)
18. [What is a SessionId on a message, and what constraints do session-aware queues o…](#q18)
19. [What is partitioning on Service Bus entities, and how does it improve throughput…](#q19)
20. [What trade-offs does the competing consumers pattern introduce for message order…](#q20)
21. [What are ServiceBusClient, ServiceBusSender, ServiceBusReceiver, and ServiceBusP…](#q21)
22. [How do you register Azure Service Bus clients and background processors in ASP.N…](#q22)
23. [What is the difference between ServiceBusProcessor and ServiceBusSessionProcesso…](#q23)
24. [How do you complete, abandon, defer, and dead-letter messages programmatically w…](#q24)
25. [How do you configure retry policies, connection resilience, and graceful shutdow…](#q25)
26. [What is the dead-letter sub-queue in Azure Service Bus, and what are the common …](#q26)
27. [How do you reprocess messages from a dead-letter sub-queue safely in .NET?](#q27)
28. [How do you authenticate to Azure Service Bus in production — connection strings,…](#q28)
