...
## Table of Contents
1. [What is Microsoft Entra ID (formerly Azure Active Directory), and how does it di…](#q1)
2. [What is an Azure Entra tenant, and what core identity objects does it contain?](#q2)
3. [What is the relationship between OAuth 2.0 and OpenID Connect (OIDC) in Azure En…](#q3)
4. [What are delegated permissions versus application permissions in Azure Entra ID?](#q4)
5. [What is an app registration in Azure Entra ID, and why do you create one?](#q5)
6. [What is a service principal, and how does it relate to an app registration?](#q6)
7. [What is the difference between the Application (client) ID and the Directory (te…](#q7)
8. [How do client secrets differ from certificates for app authentication, and when …](#q8)
9. [What is an Enterprise Application in Azure Entra ID, and how does it differ from…](#q9)
10. [Describe the authorization code flow with PKCE and why it is the recommended flo…](#q10)
11. [What is the client credentials flow, and when should a .NET background service u…](#q11)
12. [What is the on-behalf-of (OBO) flow, and what problem does it solve in multi-tie…](#q12)
13. [What are scopes, and how do they relate to API permissions in app registrations?](#q13)
14. [What is the `/.well-known/openid-configuration` endpoint, and what information d…](#q14)
15. [What is token caching, and why is it important when using MSAL in production?](#q15)
16. [What is a managed identity in Azure, and what problem does it eliminate?](#q16)
17. [What is the difference between system-assigned and user-assigned managed identit…](#q17)
18. [How does a .NET application running on Azure App Service acquire a token using a…](#q18)
19. [Which Azure services commonly use managed identities instead of client secrets?](#q19)
20. [What is MSAL (Microsoft Authentication Library), and how does it differ from the…](#q20)
21. [How do you configure an ASP.NET Core web app to sign users in with Microsoft Ent…](#q21)
22. [How does the `[Authorize]` attribute behave when Microsoft Entra ID is configure…](#q22)
23. [How do you read user claims (roles, groups, `oid`, `tid`) from an Entra ID token…](#q23)
24. [How do you protect an ASP.NET Core Web API with Azure Entra ID using JWT bearer …](#q24)
25. [What is an App Role versus a group-based authorization check in Entra ID?](#q25)
26. [How do you expose a custom API scope in an app registration and assign it to a c…](#q26)
27. [What is the audience (`aud`) claim in an Entra ID access token, and why must you…](#q27)
28. [What is a multi-tenant Azure Entra application, and what changes when you suppor…](#q28)
