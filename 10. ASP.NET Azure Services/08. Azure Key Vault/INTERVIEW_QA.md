...
## Table of Contents
1. [What is Azure Key Vault, and what three categories of cryptographic material doe…](#q1)
2. [What is the difference between a Key Vault secret, a Key Vault key, and a Key Va…](#q2)
3. [Why should production ASP.NET Core applications store sensitive configuration in…](#q3)
4. [What are soft delete and purge protection in Azure Key Vault, and why do they ma…](#q4)
5. [What is the difference between a standard Key Vault and a Key Vault with a Hardw…](#q5)
6. [How do you integrate Azure Key Vault into an ASP.NET Core application's configur…](#q6)
7. [Which NuGet packages are required to use Azure Key Vault as a configuration prov…](#q7)
8. [How are Key Vault secret names mapped to `IConfiguration` keys, and what naming …](#q8)
9. [When `AddAzureKeyVault` is called in `Program.cs`, at what point are secrets loa…](#q9)
10. [How does Azure Key Vault fit into the ASP.NET Core configuration provider hierar…](#q10)
11. [What is Azure managed identity, and how does an ASP.NET Core app running on Azur…](#q11)
12. [What is `DefaultAzureCredential`, and in what order does it attempt authenticati…](#q12)
13. [What is the difference between a system-assigned managed identity and a user-ass…](#q13)
14. [Why is storing a Key Vault client secret in `appsettings.json` or environment va…](#q14)
15. [What are Key Vault access policies, and what permissions can they grant on secre…](#q15)
16. [What is Azure Role-Based Access Control (RBAC) for Key Vault, and how does the p…](#q16)
17. [Which authorization model does Microsoft recommend for new Key Vault deployments…](#q17)
18. [Which built-in Azure RBAC roles are commonly assigned to an ASP.NET Core applica…](#q18)
19. [What does least-privilege access mean in the context of Key Vault, and why shoul…](#q19)
20. [How does secret versioning work in Azure Key Vault, and how does versioning supp…](#q20)
21. [What strategies can you use to rotate a Key Vault secret consumed by a running A…](#q21)
22. [How do you load an HTTPS certificate from Azure Key Vault for Kestrel in ASP.NET…](#q22)
23. [What is `ProtectKeysWithAzureKeyVault` in the Data Protection API, and how does …](#q23)
24. [How should developers authenticate to Key Vault during local development on a wo…](#q24)
25. [How do Azure DevOps variable groups integrate with Azure Key Vault for pipeline …](#q25)
26. [What monitoring and audit capabilities does Azure Key Vault provide, and why are…](#q26)
27. [What common mistake do developers make when they assume `AddAzureKeyVault` alone…](#q27)
