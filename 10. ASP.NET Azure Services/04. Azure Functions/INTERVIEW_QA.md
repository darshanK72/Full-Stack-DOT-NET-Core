...
## Table of Contents
1. [What is Azure Functions, and when would you choose it over Azure App Service or …](#q1)
2. [What are the core building blocks of an Azure Functions app (triggers, bindings,…](#q2)
3. [Explain the difference between a trigger and a binding in Azure Functions.](#q3)
4. [What is `host.json`, and what configuration does it control?](#q4)
5. [What is `local.settings.json`, and how does it differ from Application Settings …](#q5)
6. [How does an HTTP trigger work, and what authorization levels are available?](#q6)
7. [What is an output binding, and how does the SQL output binding in this project w…](#q7)
8. [What is `IAsyncCollector<T>` in Azure Functions bindings?](#q8)
9. [What are common input and output binding types in .NET Azure Functions?](#q9)
10. [Can a single function have multiple triggers? Why or why not?](#q10)
11. [How does binding data flow from a trigger to your function code in the in-proces…](#q11)
12. [What is the in-process Azure Functions model versus the isolated worker model?](#q12)
13. [When should you migrate from in-process to the isolated worker model for .NET?](#q13)
14. [What is Azure Functions runtime version 4, and how does it relate to .NET versio…](#q14)
15. [How does dependency injection work in Azure Functions?](#q15)
16. [Compare Consumption, Premium (Elastic Premium), and Dedicated (App Service) host…](#q16)
17. [What is cold start in Azure Functions, and what factors affect it?](#q17)
18. [How can you reduce cold start latency in production?](#q18)
19. [What are scaling characteristics and limits on the Consumption plan?](#q19)
20. [What are Durable Functions, and what problems do they solve?](#q20)
21. [Explain the difference between orchestrator, activity, and entity functions in D…](#q21)
22. [What is the difference between function chaining and fan-out/fan-in in Durable F…](#q22)
23. [How do you secure HTTP-triggered functions in production?](#q23)
24. [How does Application Insights integrate with Azure Functions (as configured in `…](#q24)
25. [What is the role of Azure Storage in a Functions app?](#q25)
26. [How do you deploy a .NET Azure Functions project to Azure?](#q26)
27. [What are common pitfalls when using SQL bindings or database connections in Azur…](#q27)
28. [Gotcha: In-process Azure Functions on .NET is being retired — what does that mea…](#q28)
