...
| # | Topic | Summary |
|---|-------|---------|
| 01 | [Azure App Service](01.%20Azure%20App%20Service/README.md) | PaaS hosting for ASP.NET Core apps with deployment slots, autoscaling, and managed identity |
| 02 | [Azure SQL Database](02.%20Azure%20SQL%20Database/README.md) | Fully managed relational SQL Server with elastic pools, DTU/vCore pricing, and geo-replication |
| 03 | [Azure Blob Storage](03.%20Azure%20Blob%20Storage/README.md) | Object storage for unstructured data: block, append, and page blobs with tiered access policies |
| 04 | [Azure Functions](04.%20Azure%20Functions/README.md) | Serverless compute triggered by events; consumption and premium plans, Durable Functions orchestrations |
| 05 | [Azure Web API Deployment](05.%20Azure%20Web%20API%20Deployment/README.md) | Publishing and versioning ASP.NET Core Web APIs to Azure with Blue/Green and canary strategies |
| 06 | [Azure API Management](06.%20Azure%20API%20Management/README.md) | Gateway layer for routing, JWT validation, rate limiting, transformations, and policy enforcement |
| 07 | [Azure DevOps Pipelines](07.%20Azure%20DevOps%20Pipelines/README.md) | YAML-based CI/CD for build, test, and multi-stage deployment across Azure targets |
| 08 | [Azure Key Vault](08.%20Azure%20Key%20Vault/README.md) | Centralized secrets, keys, and certificates management accessed securely via managed identity |
| 09 | [Azure Service Bus](09.%20Azure%20Service%20Bus/README.md) | Reliable message queuing with at-least-once delivery, sessions, dead-lettering, and topics |
| 10 | [Azure Event Grid](10.%20Azure%20Event%20Grid/README.md) | Event routing with fan-out delivery, CloudEvents schema, retry policies, and push subscriptions |
| 11 | [Azure Cosmos DB](11.%20Azure%20Cosmos%20DB/README.md) | Globally distributed, multi-model NoSQL database with partition keys and tunable consistency levels |
| 12 | [Azure Cache for Redis](12.%20Azure%20Cache%20for%20Redis/README.md) | In-memory distributed cache for session state, hot-key offload, and pub/sub messaging |
| 13 | [Azure Application Insights](13.%20Azure%20Application%20Insights/README.md) | APM telemetry platform for traces, dependencies, exceptions, Live Metrics, and Smart Detection |
| 14 | [Azure Entra ID](14.%20Azure%20Entra%20ID/README.md) | Identity platform for OAuth 2.0, OIDC, managed identities, app registrations, and RBAC |
