# 08. Real-Time & Communication Protocols

HTTP deep dive, WebSockets, SSE, SignalR, WebRTC, GraphQL, gRPC, OData.

## Topics

| # | Topic | Questions | Q&A File |
|---|-------|-----------|----------|
| 01 | HTTP Deep Dive | 0 | [README.md](./01.%20HTTP%20Deep%20Dive/README.md) |
| 02 | WebSockets in ASP.NET Core | 0 | [README.md](./02.%20WebSockets%20in%20ASP.NET%20Core/README.md) |
| 03 | Server-Sent Events (SSE) | 0 | [README.md](./03.%20Server-Sent%20Events%20(SSE)/README.md) |
| 04 | Long Polling & Transport Fallbacks | 0 | [README.md](./04.%20Long%20Polling%20%26%20Transport%20Fallbacks/README.md) |
| 05 | SignalR Fundamentals | 0 | [README.md](./05.%20SignalR%20Fundamentals/README.md) |
| 06 | SignalR Hubs, Groups & Clients | 0 | [README.md](./06.%20SignalR%20Hubs,%20Groups%20%26%20Clients/README.md) |
| 07 | SignalR with Authentication | 0 | [README.md](./07.%20SignalR%20with%20Authentication/README.md) |
| 08 | WebRTC Signaling with ASP.NET Core | 0 | [README.md](./08.%20WebRTC%20Signaling%20with%20ASP.NET%20Core/README.md) |
| 09 | GraphQL with HotChocolate | 0 | [README.md](./09.%20GraphQL%20with%20HotChocolate/README.md) |
| 10 | gRPC for Client-Facing APIs | 0 | [README.md](./10.%20gRPC%20for%20Client-Facing%20APIs/README.md) |
| 11 | OData APIs | 0 | [README.md](./11.%20OData%20APIs/README.md) |
| 12 | Choosing a Protocol | 0 | [README.md](./12.%20Choosing%20a%20Protocol/README.md) |
...
| # | Topic | Summary |
|---|-------|---------|
| 01 | [HTTP Deep Dive](01.%20HTTP%20Deep%20Dive/README.md) | HTTP/1.1 vs HTTP/2 vs HTTP/3, headers, status codes, caching, and connection lifecycle |
| 02 | [WebSockets in ASP.NET Core](02.%20WebSockets%20in%20ASP.NET%20Core/README.md) | Full-duplex TCP upgrade, middleware wiring, and raw WebSocket message handling |
| 03 | [Server-Sent Events %28SSE%29](03.%20Server-Sent%20Events%20%28SSE%29/README.md) | One-way server push over HTTP/1.1, event stream format, and browser reconnect behaviour |
| 04 | [Long Polling %26 Transport Fallbacks](04.%20Long%20Polling%20%26%20Transport%20Fallbacks/README.md) | Hanging GET pattern, timeout tuning, and why it remains the last-resort transport |
| 05 | [SignalR Fundamentals](05.%20SignalR%20Fundamentals/README.md) | Hub abstraction, connection lifecycle, and automatic transport negotiation |
| 06 | [SignalR Hubs, Groups %26 Clients](06.%20SignalR%20Hubs%2C%20Groups%20%26%20Clients/README.md) | Hub methods, group management, strongly-typed hubs, and targeted invocations |
| 07 | [SignalR with Authentication](07.%20SignalR%20with%20Authentication/README.md) | JWT on the WebSocket upgrade, query-string token delivery, and [Authorize] on hubs |
| 08 | [WebRTC Signaling with ASP.NET Core](08.%20WebRTC%20Signaling%20with%20ASP.NET%20Core/README.md) | SDP offer/answer exchange, ICE candidate relay, and STUN/TURN coordination |
| 09 | [GraphQL with HotChocolate](09.%20GraphQL%20with%20HotChocolate/README.md) | Schema-first vs code-first, queries/mutations/subscriptions, and DataLoader |
| 10 | [gRPC for Client-Facing APIs](10.%20gRPC%20for%20Client-Facing%20APIs/README.md) | Protobuf contracts, streaming RPCs, HTTP/2 requirements, and grpc-web |
| 11 | [OData APIs](11.%20OData%20APIs/README.md) | $filter/$select/$expand query options, EDM metadata, and EF Core integration |
| 12 | [Choosing a Protocol](12.%20Choosing%20a%20Protocol/README.md) | Decision matrix across REST, GraphQL, gRPC, WebSockets, SSE, and SignalR |
