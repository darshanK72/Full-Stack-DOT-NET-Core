...
## Table of Contents
1. [What is Domain-Driven Design (DDD) and what problem does it solve?](#q1)
2. [What is the difference between strategic DDD and tactical DDD?](#q2)
3. [What is a domain, a subdomain, and what are the three types of subdomains (core,…](#q3)
4. [What is ubiquitous language and why is it important in DDD?](#q4)
5. [What is a bounded context and why is it the cornerstone of strategic DDD?](#q5)
6. [What is context mapping in DDD and why does it matter?](#q6)
7. [What are the most important context-mapping relationship patterns, and what does…](#q7)
8. [What is an Anti-Corruption Layer (ACL) and when should you use one?](#q8)
9. [What is an Open Host Service (OHS) and a Published Language, and how do they ena…](#q9)
10. [What is the difference between an upstream context and a downstream context?](#q10)
11. [What is an Entity in DDD and how does it differ from a Value Object?](#q11)
12. [What is a Value Object? What makes it immutable, and when should you prefer it o…](#q12)
13. [How do you implement Entity equality and Value Object equality in C#?](#q13)
14. [What is identity in DDD — should you use database-generated IDs or domain-genera…](#q14)
15. [What is an Aggregate and what is the Aggregate Root?](#q15)
16. [What invariants do Aggregates enforce, and why must all modifications go through…](#q16)
17. [What is the one-transaction-one-aggregate rule, and what does it mean for eventu…](#q17)
18. [How do you decide the size and boundaries of an Aggregate? What are the signs of…](#q18)
19. [How should Aggregates reference each other — by object reference or by ID?](#q19)
20. [What is a Domain Event in DDD and why is it important?](#q20)
21. [What is the difference between a Domain Event and an Integration Event?](#q21)
22. [How do you dispatch Domain Events in a way that keeps the domain model clean? Wh…](#q22)
23. [What is a Domain Service and how does it differ from an Application Service?](#q23)
24. [What is a Repository in DDD and how does it differ from a data-access layer?](#q24)
25. [What is a Factory in DDD, and when should you use one instead of a constructor?](#q25)
26. [What is an anemic domain model and why is it considered an anti-pattern?](#q26)
27. [What are the standard layers in a DDD-based application, and what are the depend…](#q27)
28. [Why should the domain model have no knowledge of infrastructure concerns like da…](#q28)
29. [How do bounded contexts map to microservices, and what are the risks of mapping …](#q29)
30. [How does DDD integrate with Command Query Responsibility Segregation (CQRS)?](#q30)
31. [What is the Saga pattern and how does it relate to DDD's aggregate boundaries an…](#q31)
32. [What are the most common mistakes developers make when applying DDD in practice?](#q32)
