...
## Table of Contents
1. [What is service discovery, and why is it essential in a microservices architectu…](#q1)
2. [What is the difference between client-side service discovery and server-side ser…](#q2)
3. [How does a service registry work? What are the roles of registration, health che…](#q3)
4. [What is the difference between self-registration and third-party registration? W…](#q4)
5. [What is Consul, and what capabilities does it provide beyond simple service regi…](#q5)
6. [How do you register an ASP.NET Core microservice with Consul on startup and dere…](#q6)
7. [How does Consul determine when to remove a service instance from its registry? W…](#q7)
8. [What is the Consul DNS interface, and how can services resolve other services us…](#q8)
9. [What is .NET Aspire's built-in service discovery, and how does it differ from a …](#q9)
10. [How does `Microsoft.Extensions.ServiceDiscovery` work in .NET Aspire? What is th…](#q10)
11. [How do you configure an `HttpClient` in .NET Aspire to use service discovery so …](#q11)
12. [Why is centralized configuration management important in a microservices archite…](#q12)
13. [How does Azure App Configuration work, and how do you integrate it into an ASP.N…](#q13)
14. [How do you implement configuration hot reload in .NET so that services pick up c…](#q14)
15. [How do you use Consul's key-value store as a distributed configuration source fo…](#q15)
16. [Why should secrets (database connection strings, API keys, certificates) never b…](#q16)
17. [How do you integrate Azure Key Vault as a configuration provider in ASP.NET Core…](#q17)
18. [What is the `IOptions<T>` pattern, and what is the difference between `IOptions<…](#q18)
19. [How do you validate options at startup in ASP.NET Core so that a misconfigured s…](#q19)
20. [How do you manage environment-specific configuration across dev, staging, and pr…](#q20)
