...
## Table of Contents
1. [What is Docker and what problem does it solve? How do containers differ from vir…](#q1)
2. [What is the difference between a Docker image and a Docker container?](#q2)
3. [What is a Dockerfile? Walk through the key instructions: `FROM`, `WORKDIR`, `COP…](#q3)
4. [What is the difference between `CMD` and `ENTRYPOINT`, and why does exec form vs…](#q4)
5. [What is a multi-stage build, and why is it essential for .NET containerization?](#q5)
6. [Which .NET base images should you use for production, and what is the difference…](#q6)
7. [How does Docker layer caching work, and how do you structure a .NET Dockerfile t…](#q7)
8. [How does ASP.NET Core determine which port to listen on inside a container? What…](#q8)
9. [How do you pass configuration and connection strings to a containerized ASP.NET …](#q9)
10. [What are Docker volumes, and when do you use a volume versus a bind mount?](#q10)
11. [Explain Docker networking — what are bridge, host, and overlay networks, and whi…](#q11)
12. [What is Docker Compose, and when would you use it instead of plain `docker run`?](#q12)
13. [How do you write a production-ready `docker-compose.yml` for an ASP.NET Core mic…](#q13)
14. [How do you add a health check to a .NET container, and how does Docker use it?](#q14)
15. [How do you manage secrets in a containerized environment — what are the options …](#q15)
16. [What are the security best practices for running .NET applications in containers…](#q16)
17. [What is the difference between framework-dependent, self-contained, and Native A…](#q17)
18. [How do you debug a containerized ASP.NET Core application?](#q18)
