...
## Table of Contents
1. [What is an API Gateway, and what problem does it solve in a microservices archit…](#q1)
2. [How does an API Gateway differ from a traditional reverse proxy or load balancer…](#q2)
3. [What are the core responsibilities an API Gateway typically handles?](#q3)
4. [What is the Backend for Frontend (BFF) pattern, and how does it extend the API G…](#q4)
5. [What are the main trade-offs of introducing an API Gateway in a microservices sy…](#q5)
6. [How does an API Gateway route requests to downstream services, and what routing …](#q6)
7. [What is request aggregation in an API Gateway, and when should the gateway aggre…](#q7)
8. [What is the difference between synchronous parallel aggregation and sequential a…](#q8)
9. [How does an API Gateway perform protocol translation, such as from HTTP/REST to …](#q9)
10. [How does an API Gateway centralize authentication and authorization for downstre…](#q10)
11. [What is rate limiting at the API Gateway, what algorithms are used, and why does…](#q11)
12. [How does an API Gateway handle SSL/TLS termination, and what are the security im…](#q12)
13. [What is request and response transformation, and why might a gateway need to mod…](#q13)
14. [How does an API Gateway contribute to observability — logging, metrics, and dist…](#q14)
15. [What is Ocelot, and how does it work as an API Gateway in an ASP.NET Core applic…](#q15)
16. [How do you configure routes in Ocelot, and what does a basic ocelot.json configu…](#q16)
17. [How does Ocelot integrate with service discovery (e.g., Consul or Kubernetes), a…](#q17)
18. [What are Ocelot's built-in middleware capabilities, and how do you extend them w…](#q18)
19. [What are the known limitations of Ocelot in high-throughput or large-scale produ…](#q19)
20. [What is YARP, how does it differ from Ocelot, and when would you choose it for a…](#q20)
21. [How do you configure YARP routes and clusters in an ASP.NET Core application?](#q21)
22. [How does YARP support load balancing, and what load balancing policies does it p…](#q22)
23. [How do you implement request transformation or custom middleware with YARP?](#q23)
24. [What resilience patterns should an API Gateway implement, and how do Polly and g…](#q24)
25. [What security threats does placing an API Gateway in front of microservices help…](#q25)
26. [How do you prevent the API Gateway itself from becoming a bottleneck or single p…](#q26)
27. [When is a dedicated API Gateway unnecessary, and when does it become essential?](#q27)
28. [What is the "smart endpoints, dumb pipes" philosophy in microservices, and does …](#q28)
29. [How do you manage API Gateway configuration drift as the number of routes and se…](#q29)
30. [What are the differences between a self-hosted gateway (Ocelot, YARP) and a mana…](#q30)
