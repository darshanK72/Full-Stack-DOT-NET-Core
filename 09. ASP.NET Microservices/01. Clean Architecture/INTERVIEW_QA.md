...
## Table of Contents
1. [What is Clean Architecture, and what problem does it solve compared to a traditi…](#q1)
2. [What is the Dependency Rule in Clean Architecture, and why is it the single most…](#q2)
3. [How does Clean Architecture relate to Hexagonal Architecture (Ports & Adapters) …](#q3)
4. [What are the four concentric layers in Clean Architecture, and what is the prima…](#q4)
5. [Why does Clean Architecture make applications more testable, and which layer ben…](#q5)
6. [What belongs in the Domain layer, and what must never appear there?](#q6)
7. [What is a Domain Entity in Clean Architecture, and how is it different from a da…](#q7)
8. [What is a Value Object, and when should you model something as a Value Object ra…](#q8)
9. [What are Domain Events, and why are they raised in the Domain layer rather than …](#q9)
10. [What is an Aggregate and an Aggregate Root? What rule governs how external code …](#q10)
11. [What is the difference between a Domain Service and an Application Service?](#q11)
12. [What belongs in the Application layer, and what dependencies is it allowed to ta…](#q12)
13. [What is a Use Case (Interactor) in Clean Architecture, and what is its single re…](#q13)
14. [What is the role of interfaces defined in the Application layer (such as reposit…](#q14)
15. [How does CQRS (Command Query Responsibility Segregation) fit into the Applicatio…](#q15)
16. [What is the Mediator pattern, and why is MediatR commonly paired with Clean Arch…](#q16)
17. [What is an Application Service, and how does it differ from a Domain Service?](#q17)
18. [What belongs in the Infrastructure layer, and why does it sit at the outermost r…](#q18)
19. [What is the Repository pattern, and how does it enforce the Dependency Rule in C…](#q19)
20. [How do you implement and register an Infrastructure-layer repository so that the…](#q20)
21. [What is the difference between the Repository pattern and the Unit of Work patte…](#q21)
22. [What is the role of the Presentation layer in Clean Architecture, and what frame…](#q22)
23. [What are DTOs (Data Transfer Objects) and Mappers, and in which layer do they be…](#q23)
24. [What is the difference between a Domain Model and a ViewModel or DTO? Why must t…](#q24)
25. [How do you structure a Clean Architecture solution in .NET — which projects do y…](#q25)
26. [How do you wire up dependency injection (DI) in a Clean Architecture .NET soluti…](#q26)
27. [What is the role of the `DependencyInjection.cs` (or `ServiceCollectionExtension…](#q27)
28. [What are the main drawbacks or costs of adopting Clean Architecture for a small …](#q28)
29. [What is "Anemic Domain Model" anti-pattern, and how does it indicate that Clean …](#q29)
30. [When should you NOT use Clean Architecture, and what simpler alternatives exist …](#q30)
