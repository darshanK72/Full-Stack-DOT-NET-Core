...
## Table of Contents
1. [What does "observability" mean in the context of microservices, and how does it …](#q1)
2. [What are the three pillars of observability, and what does each one measure?](#q2)
3. [Why is observability harder in a microservices architecture than in a monolith?](#q3)
4. [What is the difference between a log, a metric, and a trace?](#q4)
5. [What is the difference between white-box monitoring and black-box monitoring?](#q5)
6. [What is a service map (or dependency graph), and how is it produced?](#q6)
7. [What is a distributed trace, and what is a span?](#q7)
8. [What is OpenTelemetry (OTel), and what problem does it solve?](#q8)
9. [What is the W3C Trace Context standard, and what are the `traceparent` and `trac…](#q9)
10. [What is the `Activity` class in .NET, and how does it relate to OpenTelemetry sp…](#q10)
11. [How do you add OpenTelemetry tracing to an ASP.NET Core microservice with outbou…](#q11)
12. [What is the OpenTelemetry Collector, and why would you use one instead of export…](#q12)
13. [What is sampling in distributed tracing, and what is the difference between head…](#q13)
14. [What are the common distributed tracing backends compatible with OpenTelemetry?](#q14)
15. [What is the difference between a trace exporter and a trace processor in the OTe…](#q15)
16. [How do you create a custom span inside an existing trace using `ActivitySource`?](#q16)
17. [What is structured logging, and why is it preferred over plain-text logging in m…](#q17)
18. [What is Serilog, and how does it differ from the built-in `Microsoft.Extensions.…](#q18)
19. [What is a log enricher in Serilog, and why is it useful in microservices?](#q19)
20. [How do you correlate log entries across multiple microservices that collaborate …](#q20)
21. [What is a log aggregation system, and which ones are commonly used with .NET mic…](#q21)
22. [What is the difference between a log's trace ID and a correlation ID?](#q22)
23. [What is `LoggerMessage.Define` / source-generated logging, and when should you p…](#q23)
24. [What are metrics, and how do they differ from traces and logs in an observabilit…](#q24)
25. [What is the .NET `Meter` API (`System.Diagnostics.Metrics`), and how does it rel…](#q25)
26. [What are the four metric instrument types in OpenTelemetry/Prometheus (Counter, …](#q26)
27. [What is Prometheus, and how does it scrape metrics from an ASP.NET Core service?](#q27)
28. [How do you expose built-in .NET runtime and ASP.NET Core metrics via OpenTelemet…](#q28)
29. [What is Grafana, and how does it relate to Prometheus in a typical metrics stack…](#q29)
30. [What is the difference between pull-based and push-based metrics collection, and…](#q30)
31. [What are health checks in ASP.NET Core, and why are they important in a microser…](#q31)
32. [What is the difference between a liveness probe and a readiness probe in Kuberne…](#q32)
33. [How do you add and expose a health check endpoint in ASP.NET Core?](#q33)
34. [How do you write a custom `IHealthCheck` for an external dependency like a datab…](#q34)
35. [What is a startup probe, and how does it differ from liveness and readiness prob…](#q35)
36. [What HTTP status codes do ASP.NET Core health check endpoints return, and what d…](#q36)
