...
## Table of Contents
1. [What is Kubernetes, and what problems does it solve for running containerized mi…](#q1)
2. [What are the main components of the Kubernetes control plane, and what does each…](#q2)
3. [What runs on each worker node in a Kubernetes cluster?](#q3)
4. [What is kubectl, and how does it communicate with the cluster?](#q4)
5. [What is a Kubernetes Namespace, and when would you use multiple namespaces in a …](#q5)
6. [What is a Pod in Kubernetes, and why is it the smallest deployable unit rather t…](#q6)
7. [What is a Deployment, and what does it manage on your behalf?](#q7)
8. [What is a ReplicaSet, and what role does it play during a Deployment rollout?](#q8)
9. [What is the difference between a RollingUpdate and a Recreate deployment strateg…](#q9)
10. [What is a StatefulSet, and when would you use one instead of a Deployment?](#q10)
11. [Why does Kubernetes use Services to expose Pods rather than using Pod IP address…](#q11)
12. [What is the difference between ClusterIP, NodePort, and LoadBalancer Service typ…](#q12)
13. [What is an Ingress resource, and how does it differ from a Service of type LoadB…](#q13)
14. [How does DNS-based service discovery work for inter-service communication within…](#q14)
15. [What is a ConfigMap, and how do you inject configuration from one into a Pod?](#q15)
16. [What is a Kubernetes Secret, and how does it differ from a ConfigMap in terms of…](#q16)
17. [What is the difference between a PersistentVolume and a PersistentVolumeClaim?](#q17)
18. [When does a .NET microservice need a PersistentVolume, and when can it avoid one…](#q18)
19. [What is the difference between a liveness probe and a readiness probe in Kuberne…](#q19)
20. [How do you configure liveness and readiness probes for an ASP.NET Core applicati…](#q20)
21. [What is a startup probe, and when should you add one alongside a liveness probe?](#q21)
22. [What are resource requests and limits, and how do they affect .NET container beh…](#q22)
23. [What is Horizontal Pod Autoscaling, and what metrics does it use by default?](#q23)
24. [How do you write a multi-stage Dockerfile for an ASP.NET Core application suitab…](#q24)
25. [How does graceful shutdown work in a .NET application running inside a Kubernete…](#q25)
26. [What environment variable naming convention must you follow to expose hierarchic…](#q26)
27. [What is Helm, and why is it used instead of raw YAML manifests for production Ku…](#q27)
28. [How does a Kubernetes rolling deployment achieve zero-downtime updates, and what…](#q28)
29. [What is a PodDisruptionBudget, and why should production deployments define one?](#q29)
...
## Chapter 06. Deploying .NET Applications on Kubernetes
