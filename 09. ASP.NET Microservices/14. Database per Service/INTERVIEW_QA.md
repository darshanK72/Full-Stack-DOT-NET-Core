...
## Table of Contents
1. [What is the Database per Service pattern, and why is it considered a foundationa…](#q1)
2. [What is the Shared Database anti-pattern in microservices, and why does it under…](#q2)
3. [What are the main benefits and trade-offs of giving every microservice its own d…](#q3)
4. [What is polyglot persistence, and how does the Database per Service pattern enab…](#q4)
5. [What are the three common levels of database isolation used in microservices (se…](#q5)
6. [What is the difference between logical isolation (separate schemas/users) and ph…](#q6)
7. [How do you choose between a relational database and a NoSQL store for a specific…](#q7)
8. [Why can microservices not share database tables or issue cross-database JOIN que…](#q8)
9. [What is the API Composition pattern, and how does it replace cross-service datab…](#q9)
10. [What is a CQRS read model (materialized view) that spans multiple services, and …](#q10)
11. [What is data duplication in the context of microservices, and why is controlled …](#q11)
12. [Why are distributed (two-phase commit) transactions impractical across microserv…](#q12)
13. [What is the Saga pattern, and how does it maintain data consistency across servi…](#q13)
14. [What is the Outbox Pattern, and why is it needed when a service must both save t…](#q14)
15. [What is eventual consistency, and how do you design a user experience that toler…](#q15)
16. [How do you manage Entity Framework Core migrations in a microservice that owns i…](#q16)
17. [What is a backward-compatible schema change, and why is it critical when service…](#q17)
18. [How do you handle reference data (lookup tables such as countries or currencies)…](#q18)
19. [How do you configure separate EF Core DbContexts for multiple microservices in t…](#q19)
20. [How do you seed initial data and run database migrations automatically on servic…](#q20)
21. [What connection string management strategies are recommended for microservices d…](#q21)
22. [What is the Repository pattern in the context of a microservice, and how does it…](#q22)
23. [How do you handle reporting and analytics queries that need data from multiple m…](#q23)
24. [What are the operational costs of the Database per Service pattern, and how do t…](#q24)
25. [When is it acceptable to start with a shared database and split later, and what …](#q25)
