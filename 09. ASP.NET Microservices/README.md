...
# 09. ASP.NET Microservices — Cross-Topic Interview Q&A
...
| # | Topic | Summary |
|---|-------|---------|
| 01 | [Clean Architecture](01.%20Clean%20Architecture/README.md) | Layers, dependency rules, and domain isolation for testable .NET microservices |
| 02 | [CQRS Pattern](02.%20CQRS%20Pattern/README.md) | Separating read and write models with MediatR command and query handlers |
| 03 | [Domain-Driven Design](03.%20Domain-Driven%20Design/README.md) | Aggregates, value objects, bounded contexts, and ubiquitous language |
| 04 | [Event-Driven Architecture](04.%20Event-Driven%20Architecture/README.md) | Integration events, outbox pattern, and async inter-service communication |
| 05 | [API Gateway Pattern](05.%20API%20Gateway%20Pattern/README.md) | Routing, aggregation, and auth offloading with YARP and Ocelot |
| 06 | [Service Discovery %26 Configuration](06.%20Service%20Discovery%20%26%20Configuration/README.md) | Consul, environment-based config, and the .NET Options pattern |
| 07 | [Docker %26 Containerization](07.%20Docker%20%26%20Containerization/README.md) | Dockerfiles, multi-stage builds, and docker-compose for local development |
| 08 | [Kubernetes Orchestration](08.%20Kubernetes%20Orchestration/README.md) | Deployments, Services, Ingress, and pod lifecycle management |
| 09 | [Distributed Messaging](09.%20Distributed%20Messaging/README.md) | RabbitMQ, Azure Service Bus, and MassTransit in .NET microservices |
| 10 | [Saga Pattern](10.%20Saga%20Pattern/README.md) | Choreography and orchestration for distributed transaction management |
| 11 | [Resilience %26 Circuit Breaker](11.%20Resilience%20%26%20Circuit%20Breaker/README.md) | Polly v8 pipelines, retry, circuit breaker, and bulkhead isolation |
| 12 | [Observability %26 Distributed Tracing](12.%20Observability%20%26%20Distributed%20Tracing/README.md) | OpenTelemetry, W3C TraceContext, structured logs, metrics, and traces |
| 13 | [gRPC Inter-Service Communication](13.%20gRPC%20Inter-Service%20Communication/README.md) | Protocol Buffers, streaming, and strongly-typed service contracts in .NET |
| 14 | [Database per Service](14.%20Database%20per%20Service/README.md) | Polyglot persistence, bounded contexts, and data ownership patterns |
...
| # | Topic | Summary |
|---|-------|---------|
| 01 | [Clean Architecture](01.%20Clean%20Architecture/INTERVIEW_QA.md) | Layers, dependency rules, and domain isolation for testable .NET microservices |
| 02 | [CQRS Pattern](02.%20CQRS%20Pattern/INTERVIEW_QA.md) | Separating read and write models with MediatR command and query handlers |
| 03 | [Domain-Driven Design](03.%20Domain-Driven%20Design/INTERVIEW_QA.md) | Aggregates, value objects, bounded contexts, and ubiquitous language |
| 04 | [Event-Driven Architecture](04.%20Event-Driven%20Architecture/INTERVIEW_QA.md) | Integration events, outbox pattern, and async inter-service communication |
| 05 | [API Gateway Pattern](05.%20API%20Gateway%20Pattern/INTERVIEW_QA.md) | Routing, aggregation, and auth offloading with YARP and Ocelot |
| 06 | [Service Discovery %26 Configuration](06.%20Service%20Discovery%20%26%20Configuration/INTERVIEW_QA.md) | Consul, environment-based config, and the .NET Options pattern |
| 07 | [Docker %26 Containerization](07.%20Docker%20%26%20Containerization/INTERVIEW_QA.md) | Dockerfiles, multi-stage builds, and docker-compose for local development |
| 08 | [Kubernetes Orchestration](08.%20Kubernetes%20Orchestration/INTERVIEW_QA.md) | Deployments, Services, Ingress, and pod lifecycle management |
| 09 | [Distributed Messaging](09.%20Distributed%20Messaging/INTERVIEW_QA.md) | RabbitMQ, Azure Service Bus, and MassTransit in .NET microservices |
| 10 | [Saga Pattern](10.%20Saga%20Pattern/INTERVIEW_QA.md) | Choreography and orchestration for distributed transaction management |
| 11 | [Resilience %26 Circuit Breaker](11.%20Resilience%20%26%20Circuit%20Breaker/INTERVIEW_QA.md) | Polly v8 pipelines, retry, circuit breaker, and bulkhead isolation |
| 12 | [Observability %26 Distributed Tracing](12.%20Observability%20%26%20Distributed%20Tracing/INTERVIEW_QA.md) | OpenTelemetry, W3C TraceContext, structured logs, metrics, and traces |
| 13 | [gRPC Inter-Service Communication](13.%20gRPC%20Inter-Service%20Communication/INTERVIEW_QA.md) | Protocol Buffers, streaming, and strongly-typed service contracts in .NET |
| 14 | [Database per Service](14.%20Database%20per%20Service/INTERVIEW_QA.md) | Polyglot persistence, bounded contexts, and data ownership patterns |
